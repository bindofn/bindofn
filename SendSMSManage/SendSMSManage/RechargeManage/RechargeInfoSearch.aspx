<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RechargeInfoSearch.aspx.cs" Inherits="RechargeManage_RechargeInfoSearch" %>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <table class="table" cellspacing="0" cellpadding="0" rules="all" border="0" onmouseover="changeto()"
                                     ...
                                     <p style="width:90%" align="right">当前查询合计冲值短信总条数：<span class="STYLE2">100</span></p>
                                </td>
