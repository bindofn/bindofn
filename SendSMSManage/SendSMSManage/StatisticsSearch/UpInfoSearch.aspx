<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpInfoSearch.aspx.cs" Inherits="StatisticsSearch_UpInfoSearch" %>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td width="95%" class="STYLE1">
                                                                    <span class="STYLE5">你当前的位置</span>：[统计查询]-[上行明细查询]
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                        ...
                                        <Columns>
                                           <asp:BoundField DataField="SrcNumber" HeaderText="发送号码" 
                                            ...
                                            <asp:TemplateField HeaderText="短信内容">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label2" runat="server" Text='<%# (Eval("MsgContent")).ToString().Length<70?Eval("MsgContent"):(Eval("MsgContent")).ToString().Substring(0,22)+"..." %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Wrap="True" />
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="RecvTime" HeaderText="接收时间" 
                                                HeaderStyle-Width="15%" >
                                            </asp:BoundField>
                                        </Columns>
                                    </asp:GridView>
                                                    ...
                                                    <table border="0" align="right" cellpadding="0" cellspacing="0">
                                                        <tbody> 
                                                            <tr>
                                                                ...
                                                                <td width="40">
                                                                    <asp:ImageButton ID="ImgGo" OnClientClick="return isNum();"
