<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SMSSend.aspx.cs" Inherits="SMSSend_SMSSend" %>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td width="95%" class="STYLE1">
                                                                    <span class="STYLE5">你当前的位置</span>：[短信发送]-[短信发送]
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td  align="center">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" CssClass="table" Width="90%">
                                    </asp:GridView>
                                </td>
