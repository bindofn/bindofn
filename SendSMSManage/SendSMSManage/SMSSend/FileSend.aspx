<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FileSend.aspx.cs" Inherits="SMSSend_FileSend" %>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td width="95%" class="STYLE1">
                                                                    <span class="STYLE5">你当前的位置</span>：[短信发送]-[文件发送]
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td align="center">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="f1" width="150px">
                                                    <span id="Span2">请选择号码文件</span>
                                                </td>
                                                <td colspan="2" align="left">
                                                    <asp:FileUpload ID="FileUpload1" runat="server" /><asp:Button ID="Button3" runat="server" Text="读取号码" />
                                                    <span id="Span4" style="color:Red;">*一行一条号码</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="f1" width="150px">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" CssClass="table" Width="100%">
                                    </asp:GridView>
                                </td>
